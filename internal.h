...
/** Sets the frequency of the note based on the parameter. The note corresponds
  * to a frequency listed in the NOTE_FREQ array
 */
void setFrequency(int freq);

/** Returns the current release time measured by pot3
 */
long getReleaseTime();
